...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Arial", padding: 24, maxWidth: 900, margin: "0 auto" }}>
      ...
      <form onSubmit={runSearch} style={{ display: "flex", gap: 8 }}>
        ...
        />
        <button type="submit" style={{ padding: "10px 14px", borderRadius: 10, border: "1px solid #ccc", cursor: "pointer" }}>
          Buscar
        </button>
      </form>
      ...
      <div style={{ marginTop: 16, display: "grid", gap: 12 }}>
        ...
        {items.map((e) => (
          <div key={e.id} style={{ border: "1px solid #eee", borderRadius: 12, padding: 12 }}>
            ...
            <div style={{ marginTop: 10, whiteSpace: "pre-wrap" }}>{e.synopsisPt}</div>
          </div>
        ))}
      </div>
    </div>
